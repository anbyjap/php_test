                ...
                if(xhr.status === 200){
                    ...
                    if(data===null){
                        ...
                        for(var i = 0; i < bms.length ; i++){
                            ...
                            var text = document.createTextNode(bms[i].user + ' ' + bms.comment);
                    ...
                    result.textContent = 'erorrrrrr mayday mayday!!'
                }
            }
            else{
                result.textContent = 'Now loading...';
            }
        };
